...
| **Peak Runoff Analysis** | SCS CN + Rational | Watershed delineation, NOAA Atlas 14, SSURGO soils, NLCD land use, CN + Rational method |
...
hydrology.py        ← pure hydrology calculations (CN, Rational, SCS interval runoff)
